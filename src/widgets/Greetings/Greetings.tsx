...
export const Greetings = (props: IGreetings) => {
	...
	return (
		<section className={styles.block}>
			<div className="flex container mx-auto justify-between gap-x-[100px]">
				<div className={styles.elementLeft}>
					<Heading data={{tag: 'h1', text: 'Добро пожаловать на сайт викторин МонетикУМ.'}} cn={{margin: 'mb-[30px]'}}/>
					<Text data={{
				...
				<div className={styles.elementRight}>
					<Image src={image} alt="Приветствие" height={600} width={694}/>
				</div>
			</div>
		</section>
	);
