			...
			<section className={block()}>
				<div className={block('wrapper-content')}>
					...
					<div className={block('body')}>
						...
						<div className={block('slider-controls', ['slider-controls'])}>
							<div className={block('navigation-prev', ['navigation-prev'])}>
							...
							<div className={block('pagination', ['pagination'])}></div>
							<div className={block('navigation-next', ['navigation-prev'])}>
								<svg width="26" height="24" viewBox="0 0 26 24" fill="none" xmlns="http://www.w3.org/2000/svg">
