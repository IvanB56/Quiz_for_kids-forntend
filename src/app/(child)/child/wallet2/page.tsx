	...
	return (
		<>
			...
			<CardInstruction data={{
				...
				image: CardInstruction2  }} cn={{margin: 'mb-[50px]', modifier: 'reverse'}} />
			<CardInstruction data={{
